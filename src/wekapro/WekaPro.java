...
//              model.mineAssociationRules();
//              System.out.println(model);
//              MyFPGrowthModel model = new MyFPGrowthModel("D:\\KHAIPHADULIEU\\data\\weather.nominal.arff", 
...
//                    "D:\\KHAIPHADULIEU\\data\\iris.arff", null, null);
//            model.trainset = model.diviTrainTestR(model.dataset, 80, false);
//            model.testset = model.diviTrainTestR(model.dataset, 80, true);
//            System.out.println(model.trainset.toSummaryString());
//            System.out.println(model.testset.toSummaryString());
              MyDecisionTreeModel model = new MyDecisionTreeModel("D:\\KHAIPHADULIEU\\data\\iris.arff", "-C 0.25 -M 2", null);
              model.buildDecisionTree();
              model.evaluateDecisionTree();
              System.out.println(model);
              
//              model.saveModel("C:\\Users\\Spring Cuong\\Desktop\\model\\decision-tree.model", model.tree);
              model.tree = (J48)model.loadModel("C:\\Users\\Spring Cuong\\Desktop\\model\\decision-tree.model");
